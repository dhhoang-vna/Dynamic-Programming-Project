...
\title{Problem Sets 7 and 8 \\ A Dynamic Model of Industrial Policy for Supply-Chain Resilience}
\author{Hung D. Hoang}
\date{\today}
...
\section{PS8 Numerical Results (VFI and PFI)}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{value_function.png}
    \caption{Value function from VFI.}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{value_function_pfi.png}
    \caption{Value function from PFI.}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{domestic_sourcing_policy.png}
    \caption{Domestic sourcing policy from VFI.}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{domestic_sourcing_policy_pfi.png}
    \caption{Domestic sourcing policy from PFI.}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{subsidy_policy.png}
    \caption{Subsidy policy from VFI.}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{subsidy_policy_pfi.png}
    \caption{Subsidy policy from PFI.}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{next_period_capacity_policy.png}
    \caption{Next-period capacity policy from VFI.}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{next_period_capacity_policy_pfi.png}
    \caption{Next-period capacity policy from PFI.}
\end{figure}
