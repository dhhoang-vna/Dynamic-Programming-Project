...
I presented a parsimonious dynamic planner model that highlights the trade-off between near-term efficiency and long-run resilience in supply chains. Industrial policy builds domestic capacity that cushions the economy against costly foreign disruptions, but it does so at a fiscal cost and with diminishing returns as capacity rises. The Bellman equation, optimality conditions, and envelope relations show how the planner balances these forces through substitution in sourcing and forward-looking investment in capacity.

Despite abstracting from multi-tier networks, endogenous link formation, and strategic interactions across firms, the model isolates the essential mechanism that makes industrial policy a form of dynamic insurance. Its simplicity makes it well suited for numerical analysis: the recursive formulation readily lends itself to value-function iteration, policy-function computation, and comparative-statics exercises.
